...
export default function Modal({ isOpen, onClose, title, children, actions }) {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/45 flex items-center justify-center z-[500] backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="bg-brown-surface border-[1.5px] border-border rounded-[18px] p-6.5 w-[520px] max-w-full max-h-[90vh] overflow-y-auto shadow-lg animate-in slide-in-from-bottom-4 duration-300">
